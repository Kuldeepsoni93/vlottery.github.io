...
<h5 class="text-center m-2">Balance: <span>₹ <?php echo number_format(wallet($con,'amount',$userid), 2);?></span></h5><hr>
    <form  name="calculator" action="#" id="paymentForm" method="post" class="card-body " autocomplete="off"> <br>
      ...
      <i style="color:#00b3b3;" class="icon ion-md-wallet">&emsp;&emsp;</i>
 ...
 <center>  <b>
     ...
     <input class="btn1 btn-sm btn-light" type="button" value="500" onclick="calculator.userammount.value = '500'">
      <input class="btn1 btn-sm btn-light" type="button" value="1000" onclick="calculator.userammount.value = '1000'">
      <input class="btn1 btn-sm btn-light" type="button" value="2000" onclick="calculator.userammount.value = '2000'"><br>
      <input class="btn1 btn-sm btn-light" type="button" value="3000" onclick="calculator.userammount.value = '3000'">
  ...
  <div class="modal-dialog" role="document">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
       ...
       <p>&nbsp;</p>
        ...
        <div class="inner-addon left-addon">
      <i style="color:#00b3b3;" class="icon ion-md-person"></i>
  <input type="text" id="name" name="name" class="form-control textbox" placeholder="Enter Your Name"  value="">
      </div>
      <div class="inner-addon left-addon">
      <i style="color:#00b3b3;" class="icon ion-md-phone-portrait"></i>
        <input type="tel" id="mobile" name="mobile" class="form-control textbox" placeholder="Enter Mobile Number"  value="<?php echo user($con,'mobile',$userid);?>">
      </div>
      <div class="inner-addon left-addon">
      <i style="color:#00b3b3;" class="icon ion-ios-mail"></i>
   <input type="text" id="email" name="email" class="form-control textbox" placeholder="Enter Email id"  value="<?php echo user($con,'email',$userid);?>">
      ...
      <p class="text-success text-center mt-3" >Please Check Your Details</p>
      <div class="text-center mt-3">
        <button type="submit" class="btn btn-primary" style="width:264px;">Recharge </button>
